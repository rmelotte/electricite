...
%C'est faux ici non? On a représenté ci-dessus le schéma simplifié lors du fonctionnement à vide, il faut juste mettre le schéma simplifié et les trois éléments sont $X_m$, $X_d$ et $R_r/g$ à priori => juste! j'ai changé le schéma 
